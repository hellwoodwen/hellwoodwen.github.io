                ...
                <main>
                    <section className="columnspan-3">
                        ...
                        <section className="poem">
                            ...
                            <br />
                            From the back<br />
                            Wick it or wreck it<br />
                            Jump up after a while as zombie revival
                            <br />
                            Or flying dutchman<br />
                            Only because the world is mad<br />
                            Doesn’t mean you have to be the same<br />
                            The world is not going to change<br />
                            And so do I<br />
                            Me - an earthly grown northern American califlower<br />
                            Silent killer<br />
                            Cocaine powder<br />
                        ...
                        <section className="poem">
                            ...
                            <br />
                            it’s freer without trail
                            <br />
                            the tides go up and down<br />
                            I can predict the direction<br />
                            Though not in detail
                            <br />
                            for macro and micro worlds have not yet united<br />
                            I doubt if they need to be
                            <br />
                            it is good to have servers of different functions in networks<br />
                            noblesse, pride, and supremacy ought to be buried with feudalism, imperialism, and monarchy<br />
                            There are rotten people living in the world with crowns<br />
                            zombies a.k.a mummies from beneath the pyramids<br />
                            disguise as persons of importance
                            <br />
                            when all their actions are a mere decoration
                            <br />
                            they are criminals producing fantasies for those who are looking back at the old days
                            <br />
                            one leg in the tomb and the other struggling to survive
                            <br />
                        ...
                        The wind in autumn is red, green and blue<br />
                        Passes through the retina to form elusive floaters<br />
                        Fear<br />
                        Is useless<br />
                        Emotions<br />
                        Are invented<br />
                        ...
                        Ships coming, opium coming,<br />
                        Industrial revolution prompted progress only for whitemen<br />
                        Racing horse or racing car<br />
                        Racists taking turns executing massacre<br />
                        We resist we fight<br />
                        We return the intruders their etiquette and kick them out of our land<br />
                        Blood flesh made brick and mortar<br />
                        Break the motor let them walk<br />
                        Oh grandma, i'll look after your chicken, goose and duck<br />
                        When the bad guys are gone<br />
